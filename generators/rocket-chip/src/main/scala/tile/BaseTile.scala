...
trait HasNonDiplomaticTileParameters {
  ...
  def dcacheArbPorts = 1 + usingVM.toInt + usingDataScratchpad.toInt + p(BuildRoCC).size + tileParams.core.useVector.toInt + 1
  // Note(DD): add 1 in the end to support PMPTW
