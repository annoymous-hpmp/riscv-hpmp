...
object DefaultTestSuites {
  ...
  val benchmarks = new BenchmarkTestSuite("rvi", "$(RISCV)/riscv64-unknown-elf/share/riscv-tests/benchmarks", LinkedHashSet(
    "median", "multiply", "qsort", "towers", "vvadd", "dhrystone", "mt-matmul", "pmp", "pmptable", "hpmp-fragmentation", "hpmp-data-frag-pt-vacontig", "hpmp-data-frag-pt-vaincontig", "hpmp-data-frag-table-vacontig", "hpmp-data-frag-table-vaincontig", "hpmp-data-frag-seg-vacontig", "hpmp-data-frag-seg-vaincontig"))
